  ...
  return (
    <div className="fade-in">
      ...
      <section className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">พรีออเดอร์เสื้อ</h2>
        <p className="text-xl text-gray-300 mb-8">ยินดีต้อนรับสู่ DY ESAN SHOP</p>
      </section>

      {/* Featured Product */}
      <section className="mb-12">
        <h3 className="text-2xl font-bold text-center text-white mb-6">สินค้าแนะนำ</h3>
